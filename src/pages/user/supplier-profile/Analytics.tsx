        ...
        {viewType === 'overview' && (
          <div className="overview">
            <div className="mb-4">
              ...
              <Bar data={productViewsData} options={{ responsive: true, plugins: { legend: { position: 'top' } } }} />
            </div>

            <div className="mb-4">
              <h4 className="font-medium">Buyer Interest Trends</h4>
              <Line data={buyerInterestData} options={{ responsive: true, plugins: { legend: { position: 'top' } } }} />
            </div>

            <div className="mb-4">
              <h4 className="font-medium">Showroom Performance</h4>
              <Pie data={showroomPerformanceData} options={{ responsive: true, plugins: { legend: { position: 'top' } } }} />
            </div>
          </div>
        )}
